		...
		makepot: {
			plugin: {
				options: {
					...
					potFilename: 'sharable-unpublish-preview.pot', // Name of the POT file.
					potHeaders: { // Headers to add to the generated POT file.
						poedit: true, // Includes common Poedit headers.
						'Last-Translator': 'Rahul Prajapati <rahul.prajapati@live.in>',
						'Language-Team': 'Dev',
						'report-msgid-bugs-to': 'https://github.com/rahulsprajapati/sharable-unpublish-preview/issues',
